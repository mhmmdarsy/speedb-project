...
/* Table schema:
CREATE TABLE kv_store_4075ff54 (
  key TEXT NOT NULL PRIMARY KEY,
  value JSONB NOT NULL
);
*/

// View at https://supabase.com/dashboard/project/liftusgljobyismswnjk/database/tables
...
export const set = async (key: string, value: unknown): Promise<void> => {
  const supabase = client();
  const { error } = await supabase.from('kv_store_4075ff54').upsert({
    key,
    value,
  });
  if (error) {
